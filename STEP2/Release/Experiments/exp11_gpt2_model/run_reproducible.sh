...
python Experiments/exp11_gpt2_model/run_exp11_gpt2_model.py \
  ...
  --results-path Experiments/Total_results/Tables/exp11_gpt2_model/Results/dphi1/metrics_diversity_ppl.json
...
python Experiments/exp11_gpt2_model/run_exp11_gpt2_model.py \
  ...
  --ppl-leash-tau 0.7 \
  --results-path Experiments/Total_results/Tables/exp11_gpt2_model/Results/dphi1_leash/metrics_diversity_ppl.json
