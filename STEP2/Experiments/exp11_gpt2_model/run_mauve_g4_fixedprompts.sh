...
EXPERIMENTS_ROOT="${STEP2_ROOT}/Experiments"
BASE_DIR="${EXPERIMENTS_ROOT}/exp11_gpt2_model"
PYTHON="${PYTHON:-python}"

CUDA_PHYSICAL_ID="${1:-0}"

cd "${STEP2_ROOT}"
export PYTHONPATH="${STEP2_ROOT}:${EXPERIMENTS_ROOT}:${PYTHONPATH:-}"
...
GEN_DIR="${GEN_DIR:-${EXPERIMENTS_ROOT}/Total_results/Tables/exp11_gpt2_model/generations_fixedprompts}"
CKPT_ROOT="${CKPT_ROOT:-${EXPERIMENTS_ROOT}/Total_results/Tables/exp11_gpt2_model/Results_streaming}"
CKPT_ROOT_DISP="${CKPT_ROOT_DISP:-${EXPERIMENTS_ROOT}/Total_results/Tables/exp11_gpt2_model/Results_streaming_ablate}"
