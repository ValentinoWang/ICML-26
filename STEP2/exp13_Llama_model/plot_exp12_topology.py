...
def main() -> None:
    ...
    vendi_csv = root / "Total_results" / "Tables" / "exp13_Llama_model" / "vendi_scores.csv"
    tsne_csv = root / "Total_results" / "Tables" / "exp13_Llama_model" / "tsne_g4_coords.csv"
    out_dir = root / "Total_results" / "Figures" / "exp13_Llama_model"
