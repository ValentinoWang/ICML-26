...
\textbf{Protocol.} Streaming PPL is evaluated on \path{exp13_Llama_model/data/val.jsonl}. MAUVE uses the \texttt{gpt2-large} featurizer with \texttt{num\_buckets=25}, \texttt{max\_text\_length=256}, and 1k generated samples vs.\ 500 validation references. Full CSVs are saved under \path{exp13_Llama_model/outputs/rec_seed1088_qwen_g0_g4_b1p5/}. Main-text results are in Section~\ref{sec:qwen2_main}.
