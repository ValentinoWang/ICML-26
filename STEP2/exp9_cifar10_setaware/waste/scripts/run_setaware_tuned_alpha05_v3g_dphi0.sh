...
# v3g Δϕ ablation: same as run_setaware_tuned_alpha05_v3.sh but disable Δϕ in selection.

python STEP2/exp9_cifar10_setaware/run_exp9_cifar10_setaware.py \
  --results-dir STEP2/exp9_cifar10_setaware/results_meta_balance_alpha05_setaware_tuned_v3g_dphi0 \
  --modes set_aware \
