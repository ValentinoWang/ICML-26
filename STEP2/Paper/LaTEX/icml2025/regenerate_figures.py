...
FIG_DIR = ROOT / "Paper" / "LaTEX" / "icml2025" / "Figures"
...
from exp7_recursive_regression.plot_exp7_recursive import (
    plot_contraction_diagnostics as plot_exp7_contraction,
    plot_series as plot_exp7_series,
)
from exp8_mnist_recursive.plot_exp8 import plot_series as plot_exp8_series, plot_series_main as plot_exp8_series_main
...
def regenerate_exp7() -> None:
    ...
    plot_exp7_contraction(
        EXPERIMENTS_ROOT / "exp7_recursive_regression" / "results" / "exp7_trajectories.csv",
        FIG_DIR / "exp7_contraction_rate.png",
    )
...
def regenerate_exp8() -> None:
    ...
    plot_exp8_series_main(stats, FIG_DIR / "exp8_curves_main.png", n_seeds=3)
    # Grids
...
def regenerate_exp9() -> None:
    ...
    if merged_baseline and merged_setaware:
        ...
        plot_exp9_times.plot_pseudo_hist_generation(
            ...
            merged_setaware,
            generation=5,
            out_path=FIG_DIR / "exp9_pseudo_gen5.png",
            extra_methods=extra_methods,
            show_legend=False,
        )
        ...
        img5 = FIG_DIR / "exp9_pseudo_gen5.png"
        if img1.exists() and img5.exists():
            ...
            canvas.save(FIG_DIR / "exp9_pseudo_gen14_final.png")
    else:
...
def compose_exp9_exp11() -> None:
    ...
    src_exp9 = FIG_DIR / "exp9_pseudo_gen14_final.png"
    ...
    pad = max(20, int(target_height * 0.04))
    canvas = Image.new("RGB", (total_width, target_height + 2 * pad), color=(255, 255, 255))
    canvas.paste(img9, (0, pad))
    canvas.paste(img11, (img9.width + sep, pad))
