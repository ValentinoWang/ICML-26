...
def main() -> None:
    ...
    vendi_csv = total_results / "Tables" / "exp13_Llama_model" / "vendi_scores.csv"
    tsne_csv = total_results / "Tables" / "exp13_Llama_model" / "tsne_g4_coords.csv"
    out_dir = total_results / "Figures" / "exp13_Llama_model"
